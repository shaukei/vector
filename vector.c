...
zend_module_entry vector_module_entry = {
	...
	vector_functions,
	PHP_MINIT(vector),
	PHP_MSHUTDOWN(vector),
	PHP_RINIT(vector),		/* Replace with NULL if there's nothing to do at request start */
	PHP_RSHUTDOWN(vector),	/* Replace with NULL if there's nothing to do at request end */
	PHP_MINFO(vector),
#if ZEND_MODULE_API_NO >= 20010901
...
PHP_INI_BEGIN()
    STD_PHP_INI_ENTRY("vector.global_value",      "42", PHP_INI_ALL, OnUpdateLong, global_value, zend_vector_globals, vector_globals)
    STD_PHP_INI_ENTRY("vector.global_string", "foobar", PHP_INI_ALL, OnUpdateString, global_string, zend_vector_globals, vector_globals)
PHP_INI_END()
*/
/* }}} */

/* {{{ php_vector_init_globals
 */
/* Uncomment this function if you have INI entries
static void php_vector_init_globals(zend_vector_globals *vector_globals)
{
	vector_globals->global_value = 0;
	vector_globals->global_string = NULL;
}
*/
/* }}} */
